...
import { PersonInformPage } from '../person-inform/person-inform';
import { PersonTopicPage } from '../person-topic/person-topic';
...
export class PersonPage {
  ...
  information(){
    this.app.getRootNav().push(PersonInformPage);
  }
  goMyTopic(){
    this.app.getRootNav().push(PersonTopicPage);
  }
  exit(){
